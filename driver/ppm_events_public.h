...
#define PPM_SC_FIELDS \
	...
	PPM_SC_X(RECV, 394) \
	PPM_SC_X(SEND, 395) \
	PPM_SC_X(S390_RUNTIME_INSTR, 396) \
	PPM_SC_X(S390_GUARDED_STORAGE, 397) \
	PPM_SC_X(READDIR, 398) \
	PPM_SC_X(S390_PCI_MMIO_READ, 399) \
	PPM_SC_X(S390_STHYI, 400) \
	PPM_SC_X(SIGACTION, 401) \
	PPM_SC_X(SIGRETURN, 402) \
	PPM_SC_X(IDLE, 403) \
	PPM_SC_X(S390_PCI_MMIO_WRITE, 404) \
	PPM_SC_X(SIGSUSPEND, 405) \
	PPM_SC_X(TIMERFD, 406)
